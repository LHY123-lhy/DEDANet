...
def ValidateSegmentation(args):
    ...
    if os.path.isfile(logFileLoc):
        ...
        logger.write(
            "\n%s\t%s\t%s\t%s\t%s\t%s\t%s" % ('Epoch', 'Kappa','OA', 'IoU', 'F1', 'R', 'P'))
    logger.flush()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savedir', default='./LEVIR4_Baseline+3_MSTB_CAA1_977', help='Directory to save the results')
